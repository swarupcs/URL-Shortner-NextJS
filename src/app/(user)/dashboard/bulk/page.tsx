  ...
  return (
    <div className='container max-w-4xl mx-auto py-10 px-4'>
      <div className='mb-8'>
        <Link
          href='/dashboard'
          className='text-sm text-muted-foreground hover:text-foreground flex items-center gap-1.5 mb-4 w-fit'
        >
          ← Back to Dashboard
        </Link>
        <h1 className='text-3xl font-bold tracking-tight flex items-center gap-3'>
          <div className='size-10 rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 flex items-center justify-center text-white'>
            <Upload className='size-5' />
          </div>
          Bulk URL Shortener
        </h1>
        <p className='text-muted-foreground mt-2'>
          Shorten up to 20 URLs at once. Enter one URL per line.
        </p>
      </div>
        ...
        <Card className='border-border/60 rounded-2xl'>
          ...
          <CardContent className='space-y-4'>
            <Textarea
              ...
              placeholder={`https://example.com/very/long/url/1\nhttps://another-long-url.com/page/2\nhttps://yet-another.com/path/3`}
